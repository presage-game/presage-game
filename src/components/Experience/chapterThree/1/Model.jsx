...
export function Model({ Materials, materials, nodes, gui }) {
  const grassTexture = useTexture("assets/images/grass_texture2.png")
  grassTexture.flipY = false

  const grassMaterial = new MeshToonMaterial({ map: grassTexture, transparent: true, color: 0x000000 })
