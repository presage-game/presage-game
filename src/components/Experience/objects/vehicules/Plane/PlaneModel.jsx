/*
Auto-generated by: https://github.com/pmndrs/gltfjsx + edit for the project
Command: npx gltfjsx@6.1.4 testplane.glb --transform
*/
...
export const Model = (props) => {
  ...
  const { nodes, materials, animations } = useGLTF("assets/vehicules/testplane-transformed.glb")
  const { actions } = useAnimations(animations, ref)

  useEffect(() => {
    props.hovered ? (materials.Tooner.color.r = 245) : (materials.Tooner.color.r = 0)
  }, [props.hovered])
...
useGLTF.preload("assets/vehicules/testplane-transformed.glb")
