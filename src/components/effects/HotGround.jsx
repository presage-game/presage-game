import { Box, Plane, RenderTexture, shaderMaterial } from "@react-three/drei"
import { extend, useFrame } from "@react-three/fiber"
import { useRef } from "react"
import { Texture, Color, TextureLoader } from "three"

const HotMaterial = shaderMaterial(
  { time: 0, uTexture: new TextureLoader().load("assets/effects/HotGround/temp_stripes.png") },
  `
  vec3 mod289(vec3 x) {
